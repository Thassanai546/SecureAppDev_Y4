...
<head>
    ...
    <title>Authenticated Page 2</title>
</head>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark p-2">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="auth_page_A.php">Auth Page A</a>
            </li>
            <li class="nav-item">
                <?php
...
<body class="bg-light">
    <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center text-dark">
        ...
        <p>Navigate the site using the header!</p>
        <img src="https://www.explainxkcd.com/wiki/images/2/29/never_told_anyone.png" alt="">
        <p></p>
        <img src="https://i.redd.it/qccshy54qz741.jpg" width=500>
    </div>
